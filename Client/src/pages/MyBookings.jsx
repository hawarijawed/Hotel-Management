...
export default function MyBookings() {
    ...
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
      <Title title='My Bookings' subtitle='Easily manag your past, current and upcoming hotel reservations in one place. Plan your trips seamlessly with just 
            ...
            border-b border-gray-300 py-6 first:border-t'>
                ...
                <div className='flex flex-col items-start justify-center pt-3'>
                    ...
                    {!booking.isPaid && (
                        ...
                        rounded-full hover:bg-green-600/30 transition-all cursor-pointer'>Pay Now</button>
                    )}
                </div>
            </div>
        ))}
