...
const AllRooms = () => {
    ...
    const handlerSortChange = (sortOptions) => {
    ...
    pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='bg-white w-80 border border-gray-300 text-gray-600
                ...
                <div className={`${openFilter ? 'h-auto' : 'h-0 lg:h-auto'} overflow-hidden transition-all duration-100`}>
                    ...
                    <div className='px-5 pt-5 pb-7'>
                        ...
                        {sortOptions.map((option, index) => (
                            <RadioButton key={index} label={option} selected={selectSort === option}
