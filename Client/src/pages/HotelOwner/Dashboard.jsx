...
const Dashboard = () => {
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='Dashboar' subtitle='Monitor your room listings,track bookings and analyze revenue-all in one place. 
      Stay updated with real-time insights to ensure smooth operations' />
      
      <div className='flex gap-4 my-8'>
        {/* Total Bookings */}
        <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
          <img src={assets.totalBookingIcon} alt="booking-icon" className='max-sm:hidder h-10'/>
        ...
        {/* Total Revenue */}
        <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
          <img src={assets.totalRevenueIcon} alt="revenue-icon" className='max-sm:hidder h-10'/>
          <div className='flex flex-col sm:ml-4 font-medium'>
