...
const Hero = () => {
    ...
    const onSearch = async (e) => {
        ...
        //Calling api to save current searched city
        try {
            const { data } = await axios.post('/api/user/store-recent-search', { recentSearchedCity: destination }, {headers: {Authorization: `Bearer ${await getToken()}`}});
            if(!data.success){
    ...
    h-screen'>
            ...
            <p className='max-w-130 mt-2 text-sm md:texxt-base'>Unparalled luxury and comfort await at the world's most exclusive hotels and resorts. Start your journey today.</p>
