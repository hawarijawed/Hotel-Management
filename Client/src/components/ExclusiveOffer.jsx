  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32'>
      <div className='flex flex-col md:flex-row items-center justify-between w-full'>
        <Title align="left" title='Exclusive Offer' subtitle='Take advantage of our 
        limited offers and special packages to enhance your stay and create unforgettable memories.' />
